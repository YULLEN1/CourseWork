...
1. Ввод валидных данных со статусом карты APPROVED shouldBuyIfCardIsApproved():
...
*Описание невалидных данных:* <br>
- месяц из 2-х букв латиницы (пр); <br>
*Ожидаемый результат:* Поле "Месяц" не заполняется <br>
...
25. Ввод цифр в поле "Владелец" shouldDeclineIfHolderIsOfNumbers: <br>
*Описание невалидных данных:* <br>
- имя и фамилия цифрами (12345); <br>
*Ожидаемый результат:* Поле "Владелец" подсвечивает сообщение: "Поле заполняется латиницей" <br>
26. Ввод спецсимволов в поле "Владелец" shouldDeclineIfHolderIsOfNumber: <br>
*Описание невалидных данных:* <br>
